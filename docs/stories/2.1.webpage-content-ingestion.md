...
- [ ] Task 1: Extend database schema for Page entity (AC: 6, 10)
  - [ ] Add Page model to Prisma schema per data model specification
  - [ ] Include fields: id, url, title, content, project_id, created_at
  - [ ] Add relationship between Page and Project models
  - [ ] Run database migration for schema updates
  - [ ] Commit with message: "feat: add Page model for content ingestion"
...
- Task 1: `[hash]` - feat: add Page model for content ingestion
