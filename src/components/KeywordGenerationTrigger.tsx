...
export default function KeywordGenerationTrigger({
  ...
  const generateKeywords = async () => {
    ...
    try {
      ...
      // Auto-generate keyword list name
      ...
      const autoGeneratedName = pageTitle
        ? `Keywords for "${pageTitle}" - ${timestamp}`
        : `Keyword Analysis - ${timestamp}`;

      // Prepare request payload
      const requestPayload = {
        keywordListName: autoGeneratedName,
